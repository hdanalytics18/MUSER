...
import static edu.usf.sas.afollestad.aesthetic.TintHelper.createTintedDrawable;
import static edu.usf.sas.afollestad.aesthetic.Util.isColorLight;
import static edu.usf.sas.afollestad.aesthetic.Util.resolveResId;
  ...
  private static void tintImageView(Object target, Field field, ActiveInactiveColors tintColors)
    ...
    if (imageView.getDrawable() != null) {
      imageView.setImageDrawable(
          TintHelper.createTintedDrawable(imageView.getDrawable(), tintColors.toEnabledSl()));
    }
  }
}
