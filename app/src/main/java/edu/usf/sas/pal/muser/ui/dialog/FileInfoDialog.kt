...
import edu.usf.sas.pal.muser.R.id.album
import edu.usf.sas.pal.muser.R.id.artist

class FileInfoDialog : DialogFragment() {

    private var fileObject: edu.usf.sas.pal.muser.model.FileObject? = null

    override fun onAttach(context: Context?) {
        super.onAttach(context)

        fileObject = arguments!!.getSerializable(ARG_FILE_OBJECT) as edu.usf.sas.pal.muser.model.FileObject
    }
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        fileSizeValue.text = edu.usf.sas.pal.muser.utils.FileHelper.getHumanReadableSize(fileObject!!.size)
    ...
    companion object {
        ...
        fun newInstance(fileObject: edu.usf.sas.pal.muser.model.FileObject): FileInfoDialog {
            val args = Bundle()
