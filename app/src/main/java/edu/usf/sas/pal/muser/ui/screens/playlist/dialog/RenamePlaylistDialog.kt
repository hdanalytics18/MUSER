...
class RenamePlaylistDialog : DialogFragment() {
    ...
    private var playlist: edu.usf.sas.pal.muser.model.Playlist? = null
    ...
    private fun setSaveButton(dialog: MaterialDialog, playlist: edu.usf.sas.pal.muser.model.Playlist?, typedName: String) {
    ...
    companion object {
        ...
        fun newInstance(playlist: edu.usf.sas.pal.muser.model.Playlist): RenamePlaylistDialog {
            val args = Bundle()
