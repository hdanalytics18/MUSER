...
class M3uPlaylistDialog : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        disposable = songsRepository.getSongs(playlist)
            .first(emptyList())
            .map(Function<List<edu.usf.sas.pal.muser.model.Song>, File> { songs ->
                if (!songs.isEmpty()) {
            ...
            .subscribe(
                ...
                { error -> edu.usf.sas.pal.muser.utils.LogUtils.logException(TAG, "Error saving m3u playlist", error) }
            )
    ...
    companion object {
        ...
        fun newInstance(playlist: edu.usf.sas.pal.muser.model.Playlist): M3uPlaylistDialog {
            val args = Bundle()
