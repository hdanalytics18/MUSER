    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        webView.webViewClient = object : WebViewClient() {
            override fun onPageFinished(view: WebView, url: String) {
                ...
                edu.usf.sas.pal.muser.utils.ViewUtils.fadeOut(progressBar) { edu.usf.sas.pal.muser.utils.ViewUtils.fadeIn(webView, null) }
            }
        ...
        edu.usf.sas.afollestad.aesthetic.Aesthetic.get(context)
            .isDark
            .take(1)
