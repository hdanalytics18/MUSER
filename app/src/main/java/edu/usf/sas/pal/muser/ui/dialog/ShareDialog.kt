...
class ShareDialog : DialogFragment() {
    ...
    private lateinit var song: edu.usf.sas.pal.muser.model.Song

    override fun onAttach(context: Context?) {
        super.onAttach(context)

        song = arguments!!.getSerializable(ARG_SONG) as edu.usf.sas.pal.muser.model.Song
    }
    ...
    companion object {
        ...
        fun newInstance(song: edu.usf.sas.pal.muser.model.Song): ShareDialog {
            val args = Bundle()
