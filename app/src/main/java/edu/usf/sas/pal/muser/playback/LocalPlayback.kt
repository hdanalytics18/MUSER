    ...
    private val audioNoisyReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            if (AudioManager.ACTION_AUDIO_BECOMING_NOISY == intent.action) {
                ...
                if (isPlaying) {
                    val intent = Intent(context, edu.usf.sas.pal.muser.playback.MusicService::class.java)
                    intent.action = edu.usf.sas.pal.muser.playback.constants.ServiceCommand.COMMAND
                    intent.putExtra(edu.usf.sas.pal.muser.playback.constants.MediaButtonCommand.CMD_NAME, edu.usf.sas.pal.muser.playback.constants.ServiceCommand.PAUSE)
