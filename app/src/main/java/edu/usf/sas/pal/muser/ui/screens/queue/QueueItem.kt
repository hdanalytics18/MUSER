...
class QueueItem(var song: edu.usf.sas.pal.muser.model.Song, var occurrence: Int) {
...
fun List<edu.usf.sas.pal.muser.model.Song>.toQueueItems(): List<QueueItem> {
...
fun List<QueueItem>.toSongs(): List<edu.usf.sas.pal.muser.model.Song> {
