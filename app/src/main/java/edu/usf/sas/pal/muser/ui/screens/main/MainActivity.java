...
import edu.usf.sas.pal.muser.BuildConfig;
import edu.usf.sas.pal.muser.R;
import edu.usf.sas.pal.muser.data.Repository;
import edu.usf.sas.pal.muser.model.Playlist;
import edu.usf.sas.pal.muser.model.Query;
import edu.usf.sas.pal.muser.playback.MediaManager;
import edu.usf.sas.pal.muser.playback.constants.ShortcutCommands;
import edu.usf.sas.pal.muser.sql.sqlbrite.SqlBriteUtils;
import edu.usf.sas.pal.muser.ui.common.BaseActivity;
import edu.usf.sas.pal.muser.ui.common.ToolbarListener;
import edu.usf.sas.pal.muser.ui.dialog.ChangelogDialog;
...
import edu.usf.sas.pal.muser.utils.MusicServiceConnectionUtils;
import edu.usf.sas.pal.muser.utils.SettingsManager;
import edu.usf.sas.pal.muser.utils.ThemeUtils;
